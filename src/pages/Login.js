    ...
    <div className='min-h-screen bg-[#0f1b39]'>
      <div className='flex justify-center pt-20'>
        <div className='flex flex-col'>
          ...
          <div className='shadow-2xl bg-white border-dashed border-4 rounded-2xl h-[69vh] p-16'>
            <form onSubmit={handleSubmit} className='flex flex-col space-y-12'>
              ...
              <div>
                <button type='submit' className='font-medium hover:bg-white hover:text-black hover:border-black hover:border-2 bg-[#0f1b39] text-white rounded-lg p-3 w-full'>Login</button>
              </div>
            </form>
          </div>
        </div>
